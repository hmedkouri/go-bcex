...
func (client *Client) GetSymbols() (symbols []Symbol, err error) {
	r, err := client.do("GET", "symbols", nil, false)
	if err != nil {
		return
	}
...
func (client *Client) GetSymbol(market string) (symbol Symbol, err error) {
	r, err := client.do("GET", "symbols/"+strings.ToUpper(market), nil, false)
	if err != nil {
		return
	}
	var response interface{}
...
func (client *Client) GetAllTicker() (tickers Tickers, err error) {
	r, err := client.do("GET", "tickers", nil, false)
	if err != nil {
		return
	}
	var response interface{}
...
func (client *Client) GetTicker(market string) (ticker Ticker, err error) {
	r, err := client.do("GET", "tickers/"+strings.ToUpper(market), nil, false)
	if err != nil {
		return
	}
	var response interface{}
...
func (client *Client) GetL2Orderbook(market string) (orderbook OrderBook, err error) {
	r, err := client.do("GET", "l2/"+strings.ToUpper(market), nil, false)
	if err != nil {
		return
	}
	var response interface{}
...
func (client *Client) GetL3Orderbook(market string) (orderbook OrderBook, err error) {
	r, err := client.do("GET", "l3/"+strings.ToUpper(market), nil, false)
	if err != nil {
		return
	}
	var response interface{}
